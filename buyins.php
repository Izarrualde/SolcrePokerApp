			...
			<article class="col-md-9">
				...
				<table class="table table-bordered table-hover table-condensed">
					...
					<tbody>
						...
						?>
							<tr>
								<td> <center> <?php echo $buyin->getId() ?> </center> </td>
								<td> <center> <?php echo $buyin->getIdPlayer() ?> </center> </td>
								<td> <center> <?php echo $buyin->getAmountCash() ?> </center> </td>
								<td> <center> <?php echo $buyin->getAmountCredit() ?> </center> </td>
								<td> <center> <?php echo $buyin->getCurrency() ?> </center> </td>
								<td> <center> <?php echo $buyin->getHour() ?> </center> </td>
								<td> <center> <?php echo $buyin->getApproved() ?> </center> </td>
							</tr>
						<?php
						}
						?>
