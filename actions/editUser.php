...
<head>
	<meta charset="UTF-8">
	<title>Editar Sesión de Usuario </title>
					...
					<section class="container row justify-content-center">
						<article>
							<form class="was-validated" action="" method="post">
								...
								<input class="form-control" name="accumulatedPoints" id="accumulatedPoints" type="hidden" required="true" value="<?php echo $datos[0]->points; ?>">

								<input name="approved" id="approved" type="hidden" value="<?php echo $datos[0]->is_approved; ?>">

								<input class="form-control" name="cashout" id="cashout" type="hidden" required="true" value="">
								...
								<input class="form-control" name="end" id="end" type="hidden" value="">

								<!-- para edit user inactivo si usar esta
								<div class="form-group">
